...
> Stato al 2026-06-04. ✅ = fatto · ⬜ = da fare · 🔁 = da verificare in fase di archive.
...
- ✅ Icona app 1024×1024 (single-size) — ⬜ verificare che **non abbia canale alpha/trasparenza** (l'App Store la rifiuta)
...
- ⬜ **Deploy dello schema CloudKit in Production**: CloudKit Dashboard → container `iCloud.it.systema360.equinozio` → "Deploy Schema Changes" da Development a **Production**. Senza questo, per gli utenti App Store la sincronizzazione non funziona.
